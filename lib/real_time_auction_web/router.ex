defmodule RealTimeAuctionWeb.Router do
  use RealTimeAuctionWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {RealTimeAuctionWeb.LayoutView, :root}
  ...
  # scope "/api", RealTimeAuctionWeb do
  #   pipe_through :api
  # end
